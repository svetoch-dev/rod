...
export PG_EXPORTER_LOG_LEVEL=${PG_EXPORTER_LOG_LEVEL:-info}
export PG_EXPORTER_LOG_FORMAT=${PG_EXPORTER_LOG_FORMAT:-json}
...
export PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_INCLUDE_QUERY=${PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_INCLUDE_QUERY:-false}
export PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_QUERY_LENGTH=${PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_QUERY_LENGTH:-120}
...
PG_EXPORTER_ARGS="--web.listen-address=:${PG_EXPORTER_WEB_LISTEN_ADDRESS} --log.format=${PG_EXPORTER_LOG_FORMAT} --log.level=${PG_EXPORTER_LOG_LEVEL} --collector.stat_statements.query_length=${PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_QUERY_LENGTH}"
...
[[ $PG_EXPORTER_COLLECTOR_STAT_STATEMENTS_INCLUDE_QUERY == true ]] && PG_EXPORTER_ARGS="$PG_EXPORTER_ARGS --collector.stat_statements.include_query" || PG_EXPORTER_ARGS="$PG_EXPORTER_ARGS --no-collector.stat_statements.include_query"
