...
module "cloud_config" {
  source = "git::https://github.com/svetoch-dev/tf-modules.git//modules/{env.cloud.name}/client_config?ref=v0.18.1"
  provider_config =  {
...
module "secrets" {
  source          = "git::https://github.com/svetoch-dev/tf-modules.git//modules/rod/secrets?ref=v0.18.1"
  env             = local.env
  argocd_clusters = {}
  argocd_repos    = {}
