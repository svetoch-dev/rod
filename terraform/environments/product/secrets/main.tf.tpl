...
module "cloud_config" {
  source = "git::https://github.com/svetoch-dev/tf-modules.git//modules/{env.cloud.name}/client_config?ref=v0.19.0"
  provider_config =  {
...
module "secrets" {
  source          = "git::https://github.com/svetoch-dev/tf-modules.git//modules/rod/secrets?ref=v0.19.0"
  env             = local.env
  argocd_clusters = {}
  argocd_repos    = {}
