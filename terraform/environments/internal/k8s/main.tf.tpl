...
module "cloud_config" {
  source    = "git::https://github.com/svetoch-dev/tf-modules.git//modules/{env.cloud.name}/client_config?ref=v0.20.0"
  provider_config =  {
...
module "k8s" {
  source    = "git::https://github.com/svetoch-dev/tf-modules.git//modules/rod/k8s/internal?ref=v0.20.0"
