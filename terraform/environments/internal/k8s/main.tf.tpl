...
module "cloud_config" {
  source    = "git::https://github.com/svetoch-dev/tf-modules.git//modules/{env.cloud.name}/client_config?ref=6e94dfd7b6baf45cab577c83d3f8422364ff6f7e"
  provider_config =  {
...
module "k8s" {
  source    = "git::https://github.com/svetoch-dev/tf-modules.git//modules/rod/k8s?ref=6e94dfd7b6baf45cab577c83d3f8422364ff6f7e"
